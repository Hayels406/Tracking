...
if os.getcwd().rfind('hayley') > 0:
    ...
    save = '/users/hayleymoore/Documents/PhD/Tracking/CaseH3/'
elif os.getcwd().rfind('Uni') > 0:
    videoLocation = '/home/b1033128/Documents/CaseH3.mov'
    save = '/home/b1033128/Documents/CaseH3/'
    dell = True
    brk = False
else:#Kiel
...
blackSheepCov = []
frameID = 0
cropVector = [1500,550,2000,850]
quadCrop   = [1150,700,1250,800]
                    ...
                    if (cY < 300): #tree limits
                        if numPixels < oneSheepPixels/2.:
                            ...
                            if init == False:
                                ...
                                #plt.pause(0.0001)
                                guessed = int(np.round(numPixels/sizeSheep))
...
np.save(save+'Final-loc'+str(frameID), sheepLocations)
np.save(save+'Final-quad'+str(frameID), np.array(quadLocation))
