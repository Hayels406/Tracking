...
if os.getcwd().rfind('hayley') > 0:
    videoLocation = '/users/hayleymoore/Documents/PhD/Tracking/CaseJ2.mov'
    save = '/users/hayleymoore/Documents/PhD/Tracking/CaseJ2/'
elif os.getcwd().rfind('Uni') > 0:
    videoLocation = '/home/b1033128/Documents/CaseJ2.mov'
    save = '/home/b1033128/Documents/CaseJ2/'
    dell = True
    brk = False
else:#Kiel
    videoLocation = '/data/b1033128/Videos/CaseJ2.mov'
    save = '/data/b1033128/Tracking/CaseJ2/'
    dell = False
...
blackSheepCov = []
frameID = 0
cropVector = [900,450,1500,800]
quadCrop   = [700,520,800,620]
...
print 'Skipping first 10 frames while a sheep is hiding under the tree'
while(frameID <= 10):
    ret, frame = cap.read()
    frameID += 1
skip = frameID
...
while(frameID <= runUntil):
    ...
    if ret == False:
        ...
        if plot != 'N':
            ...
            if plot == 's':
                plt.savefig(save+'filtered/'+str(frameID+skip+10).zfill(4), bbox_inches='tight')
