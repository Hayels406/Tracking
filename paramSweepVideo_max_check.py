...
os.system('mkdir -p ' + save+'ParamSweep/maximumL'+str(lG))
os.system('mkdir -p ' + save+'ParamSweep/maximumL'+str(lG))
...
plt.savefig(save+'ParamSweep/maximumL'+str(lG)+'/filtered'+str(frameID+skip+19).zfill(4), bbox_inches='tight')
...
plt.gca().set_aspect('equal')
plt.gca().set_axis_off()
plt.savefig(save+'ParamSweep/maximumL'+str(lG)+'/'+str(frameID+skip+19-1).zfill(4), bbox_inches='tight')

np.savetxt(save+'ParamSweep/maximumL'+str(lG)+'/sheepDetected.csv', [int(l)], fmt='%i')
